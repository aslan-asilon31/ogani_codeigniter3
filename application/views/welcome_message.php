<main class="main">
	...
	<section class="home" id="home">
		<div class="home__container container grid">
			<img src="<?php echo base_url()?>/assets/frontend/img/home.png" alt="" class="home__img">
	...
	<section class="about section container" id="about">
		<div class="about__container grid">
			<img src="<?php echo base_url()?>/assets/frontend/img/about.png" alt="" class="about__img">
	...
	<section class="product section container" id="products">
		...
		<div class="product__container grid">
			<article class="product__card">
				...
				<img src="<?php echo base_url()?>/assets/frontend/img/product1.png" alt="" class="product__img">
			...
			<article class="product__card">
				...
				<img src="<?php echo base_url()?>/assets/frontend/img/product2.png" alt="" class="product__img">
			...
			<article class="product__card">
				...
				<img src="<?php echo base_url()?>/assets/frontend/img/product3.png" alt="" class="product__img">
			...
			<article class="product__card">
				...
				<img src="<?php echo base_url()?>/assets/frontend/img/product4.png" alt="" class="product__img">
			...
			<article class="product__card">
				...
				<img src="<?php echo base_url()?>/assets/frontend/img/product5.png" alt="" class="product__img">
			...
			<article class="product__card">
				...
				<img src="<?php echo base_url()?>/assets/frontend/img/product6.png" alt="" class="product__img">
